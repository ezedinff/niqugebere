                ...
                <form class="col s12 m12 no-padding center" role="form"  method="POST" action="{{ route('login') }}">
                    ...
                    <div class="card z-depth-5">
                        <div class="card-content center" >
                            <img src="{{asset('img/logo.png')}}" width="148"  style="margin-bottom: 20px;"/>
                            ...
                            <div class="row">
                                <div class="input-field col s12 m12 {{ $errors->has('email') ? ' has-error' : '' }}" style="padding-left: 0;">
                                    ...
                                    <label for="tin" data-error="wrong" data-success="right">Tin<sup class="fa fa-asterisk" style="color: red;"></sup></label>
                                    @if ($errors->has('email'))
